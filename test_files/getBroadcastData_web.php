...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    */        
    ...
    if (isset($authorization)) {
        ...
        $selectQuery = $db->query("SELECT BROADCASTS.B_Id, BROADCASTS.B_HostId, BROADCASTS.B_RoomName, BROADCASTS.B_IsLive, BROADCASTS.B_LiveStartedAt, 
        ...
        ORDER BY B_LiveStartedAt DESC LIMIT $dataStartIndex, $numberOfDataPerRequest;");
        ...
        if ($selectQuery->num_rows > 0){        
            ...
            while($row = $selectQuery->fetch_assoc()) {      
                ...
                if (isset($row['B_RecordedMedia'])) {
                // Blob data can be large, and encoding it directly in a JSON array can cause problems.
                // So, we use base64.
                    $base64MediaData = base64_encode($row['B_RecordedMedia']);  
                    $eachData['recordedMedia'] = $base64MediaData;
                }
